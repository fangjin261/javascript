...
const avengers = ['美国队长','钢铁侠','雷神','绿巨人'];
const c = avengers.splice(2,2,'fangjin',2,3)
console.log(c);
console.log(avengers);
...
console.log(romanNumberals);
console.log(romanNumberals.size);
console.log(romanNumberals.get(3));
console.log(romanNumberals.has(5));
romanNumberals.delete(5);
console.log(romanNumberals);
...
const romanNumberals = new Map();
romanNumberals.set(1,'I').set(2,'II').set(3,'III').set(4,'IV').set(5,'V');
const oArray1 = [...romanNumberals];
const oArray2 = Array.from(romanNumberals);
console.log(oArray1);
console.log(oArray2);
